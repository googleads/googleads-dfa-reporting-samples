...
{
    /// <summary>
    /// This example gets the first page of a particular type of dimension available for reporting
    /// in the given date range. You can use a similar workflow to retrieve the values for any
    /// dimension.
    /// 
