...
{
    /// <summary>
    /// A sample application that runs multiple requests against the DFA Reporting API. These
    /// include:
    /// <list type="bullet">
    /// <item>
    ...
    /// <item>
    /// <description>
    /// Listing the first 50 available Floodlight configuration IDs for a user profile
    /// </description>
    /// </item>
    /// <item>
    ...
    internal class Program
    {
        ...
        private static void CreateAndRunStandardReport(DfareportingService service,
            long userProfileId)
        {
