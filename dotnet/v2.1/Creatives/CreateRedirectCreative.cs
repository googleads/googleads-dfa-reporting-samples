...
using System;
using Google.Apis.Dfareporting.v2_1;
using Google.Apis.Dfareporting.v2_1.Data;

namespace DfaReporting.Samples {
  /// <summary>
  /// This example creates a redirect creative associated with a given
  /// advertiser. To get a size ID, run GetSize.cs.
  ///
  /// Tags: creatives.insert
  /// </summary>
  class CreateRedirectCreative : SampleBase {
    /// <summary>
    /// Returns a description about the code example.
    /// </summary>
    public override string Description {
      get {
        return "This example creates a redirect creative associated with a" +
            " given advertiser. To get a size ID, run GetSize.cs.\n";
      }
    }
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new CreateRedirectCreative();
