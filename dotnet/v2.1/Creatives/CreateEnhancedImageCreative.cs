...
namespace DfaReporting.Samples {
  /// <summary>
  /// This example uploads creative assets and creates an enhanced image
  /// creative associated with a given advertiser. To get a size ID, run
  /// GetSize.cs.
  ///
  /// Tags: creatives.insert
  /// </summary>
  class CreateEnhancedImageCreative : SampleBase {
    /// <summary>
    ...
    public override string Description {
      get {
        return "This example uploads creative assets and creates an enhanced" +
            " image creative associated with a given advertiser. To get a" +
    ...
    public static void Main(string[] args) {
      SampleBase codeExample = new CreateEnhancedImageCreative();
