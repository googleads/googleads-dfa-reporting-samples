...
argparser.add_argument(
    'profile_id', type=int,
    help='The ID of the profile to add a creative field for')
argparser.add_argument(
    'advertiser_id', type=int,
    help='The ID of the advertiser to add a creative field for')
...
def main(argv):
  ...
  try:
    ...
    request = service.creativeFields().insert(
        profileId=str(profile_id), body=creative_field
    )
