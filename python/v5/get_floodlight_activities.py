...
argparser.add_argument(
    'profile_id', type=int,
    help='The ID of the profile to list activities for')
argparser.add_argument(
    'advertiser_id', type=int,
    help='The ID of the advertiser to list activities for')
...
def main(argv):
  ...
  try:
    ...
    request = service.floodlightActivities().list(
        profileId=str(profile_id), advertiserId=str(advertiser_id)
    )
