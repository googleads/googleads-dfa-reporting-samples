...
public class CreativeAssetUtils {
   ...
   * @return A {@link CreativeAssetId} object populated with the name of the asset after insert.
   */
  public static CreativeAssetId uploadAsset(Dfareporting reporting, long profileId,
