 ...
 *
 * <p>Note: The id and accountId parameters are required. The tvDataProvider and countryDartId
...
public class GetTvCampaignDetail {
  ...
  public static void runExample(
    ...
    System.out.printf(
        "Searching for TV campaign detail with ID: %s, country Dart ID: %d, and TV data provider:"
            + " %s%n",
        id, countryDartId, tvDataProvider);

    // Create and execute the TV campaign detail get request.
    TvCampaignDetail tvCampaignDetail =
        reporting
            .tvCampaignDetails()
            .get(profileId, id)
  ...
  public static void main(String[] args) throws Exception {
    ...
    runExample(reporting, profileId, accountId, ID, countryDartId, TV_DATA_PROVIDER);
  }
}
