...
/**
 * This example creates a display redirect creative associated with a given advertiser. To get a
 * size ID, run GetSize.java.
 */
public class CreateDisplayRedirectCreative {
  ...
  public static void runExample(Dfareporting reporting, long profileId, long advertiserId,
    ...
    System.out.printf("Display redirect creative with ID %d was created.%n", result.getId());
  }
