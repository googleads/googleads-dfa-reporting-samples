...
def insert_offline_mobile_conversion(dfareporting, args)
  ...
  conversion = {
    ...
    :mobileDeviceId => args[:mobile_device_id],
...
if __FILE__ == $0
  ...
  args = DfaReportingUtils.get_arguments(
      ARGV, :profile_id, :mobile_device_id, :floodlight_activity_id)

  # Authenticate and initialize API service
  dfareporting = DfaReportingUtils.setup()

  insert_offline_mobile_conversion(dfareporting, args)
end
