...
def update_report(profile_id, report_id)
  ...
  # Update the report
  report.name = 'Example Standard Report (Updated)'

  result = service.update_report(profile_id, report_id, report)
...
if __FILE__ == $0
  ...
  update_report(args[:profile_id], args[:report_id])
end
