...
class GetCompatibleFields extends BaseExample
{
    ...
    public function run()
    {
        ...
        $report = $this->service->reports->get(
        ...
        $this->printResultsTable(
            'Dimensions',
            $fields->getReportCompatibleFields()->getDimensions()
        );

        // Print the compatible metrics
        $this->printResultsTable(
            'Metrics',
            $fields->getReportCompatibleFields()->getMetrics()
        );

        // Print the compatible dimension filters
        $this->printResultsTable(
            'Dimension Filters',
            $fields->getReportCompatibleFields()->getDimensionFilters()
        );

        // Print the compatible pivoted activity metrics
        $this->printResultsTable(
            'Pivoted Activity Metrics',
            $fields->getReportCompatibleFields()->getPivotedActivityMetrics()
        );
    }
